    ...
    <div>
      ...
      <div className="mb-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <button onClick={() => bulkUpdateStatus()} className="px-3 py-1 bg-blue-600 text-white rounded" disabled={selectedIds.length===0}>Apply status</button>
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-3 gap-4">
          {items.map((it) => (
            <div key={it.id} className="relative p-4 bg-white shadow rounded">
