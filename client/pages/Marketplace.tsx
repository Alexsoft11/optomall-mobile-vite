  ...
  return (
    <div className="px-4 pb-6 pt-4 space-y-4">
      ...
      <div className="flex items-center gap-2 overflow-x-auto pb-1">
        <button className="chip whitespace-nowrap"><SlidersHorizontal className="size-4"/> Filters</button>
        ...
        <button className="chip whitespace-nowrap"><Filter className="size-4"/> More</button>
        <button className="chip whitespace-nowrap">Price <ChevronDown className="size-4"/></button>
      </div>
        ...
        {products.map((p) => (
          <GlassCard key={p.id} className="overflow-hidden">
            ...
            <div className="p-3">
              ...
              <button className="mt-2 inline-flex items-center justify-center w-full h-9 rounded-xl bg-primary text-primary-foreground text-sm">Add</button>
            </div>
          </GlassCard>
        ))}
      </div>
