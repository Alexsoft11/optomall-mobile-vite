export const products = [
  {
    ...
    price: 249.0,
    description:
      "A lightweight, sculptural chair with orbital curves and soft matte finish.",
    images: [
  ...
  },
  {
    ...
    price: 129.0,
    description:
      "Soft ambient lamp with halo ring — perfect for modern interiors.",
    images: [
      "https://images.unsplash.com/photo-1549187774-b4e9f0447ee7?auto=format&fit=crop&w=800&q=80",
    ],
  },
  {
    id: 3,
    ...
    images: [
      "https://images.unsplash.com/photo-1616628181073-0a3b6b0a6a5f?auto=format&fit=crop&w=800&q=80",
    ],
  },
  {
    id: 4,
    ...
    images: [
      "https://images.unsplash.com/photo-1582582494703-3f49f1f3b70d?auto=format&fit=crop&w=800&q=80",
    ],
  },
